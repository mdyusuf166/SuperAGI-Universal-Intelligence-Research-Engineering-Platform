...
- Project name: biomni
- GitHub URL: https://github.com/snap-stanford/Biomni.git
- Purpose: Biomedical research agent
...
- Why SuperAGI uses it: Biomedical AGI and bioinformatics research
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/snap-stanford/Biomni.git for upstream authorship and terms.
