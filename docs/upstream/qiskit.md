...
- Project name: qiskit
- GitHub URL: https://github.com/Qiskit/qiskit.git
- Purpose: Quantum computing SDK
...
- Why SuperAGI uses it: Quantum circuit and algorithm research
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/Qiskit/qiskit.git for upstream authorship and terms.
