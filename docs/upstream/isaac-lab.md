...
- Project name: isaac-lab
- GitHub URL: https://github.com/isaac-sim/IsaacLab.git
- Purpose: GPU-accelerated robot learning framework
...
- Why SuperAGI uses it: Robot learning and embodied simulation
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/isaac-sim/IsaacLab.git for upstream authorship and terms.
