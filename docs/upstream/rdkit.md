...
- Project name: rdkit
- GitHub URL: https://github.com/rdkit/rdkit.git
- Purpose: Cheminformatics and molecular representations
...
- Why SuperAGI uses it: Molecular graph and descriptor operations
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/rdkit/rdkit.git for upstream authorship and terms.
