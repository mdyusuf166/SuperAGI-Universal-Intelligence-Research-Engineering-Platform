...
- Project name: qiskit-aer
- GitHub URL: https://github.com/Qiskit/qiskit-aer.git
...
- Why SuperAGI uses it: Local quantum simulation backend
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/Qiskit/qiskit-aer.git for upstream authorship and terms.
