...
- Project name: scientific-agent-skills
- GitHub URL: https://github.com/K-Dense-AI/scientific-agent-skills.git
- Purpose: Reusable scientific agent skills
...
- Why SuperAGI uses it: Scientific tool and workflow skill catalog
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/K-Dense-AI/scientific-agent-skills.git for upstream authorship and terms.
