...
- GitHub URL: https://github.com/microsoft/graphrag.git
...
- Why SuperAGI uses it: Knowledge graph indexing and retrieval
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/microsoft/graphrag.git for upstream authorship and terms.
