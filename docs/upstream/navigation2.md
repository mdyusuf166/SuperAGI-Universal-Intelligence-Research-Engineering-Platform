...
- GitHub URL: https://github.com/ros-navigation/navigation2.git
- Purpose: ROS 2 navigation stack
...
- Why SuperAGI uses it: Autonomous navigation planning
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/ros-navigation/navigation2.git for upstream authorship and terms.
