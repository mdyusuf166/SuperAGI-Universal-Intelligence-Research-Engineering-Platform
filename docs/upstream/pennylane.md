...
- GitHub URL: https://github.com/PennyLaneAI/pennylane.git
- Purpose: Quantum machine learning and differentiable programming
...
- Why SuperAGI uses it: Hybrid quantum-classical research
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/PennyLaneAI/pennylane.git for upstream authorship and terms.
