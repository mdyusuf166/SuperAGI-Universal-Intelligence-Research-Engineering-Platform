...
- Project name: gazebo-sim
- GitHub URL: https://github.com/gazebosim/gz-sim.git
- Purpose: Robotics simulation
...
- Why SuperAGI uses it: Simulated robot environments
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/gazebosim/gz-sim.git for upstream authorship and terms.
