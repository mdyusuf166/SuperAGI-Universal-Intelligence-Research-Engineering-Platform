...
- Project name: ros2
- GitHub URL: https://github.com/ros2/ros2.git
- Purpose: Robotics middleware and ecosystem
...
- Why SuperAGI uses it: Robotics AGI messaging and control boundary
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/ros2/ros2.git for upstream authorship and terms.
