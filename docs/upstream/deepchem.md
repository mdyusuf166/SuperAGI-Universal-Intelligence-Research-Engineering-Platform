...
- Project name: deepchem
- GitHub URL: https://github.com/deepchem/deepchem.git
- Purpose: Machine learning for molecular and chemical science
...
- Why SuperAGI uses it: Molecular modeling and drug discovery research
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/deepchem/deepchem.git for upstream authorship and terms.
