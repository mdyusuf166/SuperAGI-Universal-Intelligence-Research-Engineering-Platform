...
- Project name: chemprop
- GitHub URL: https://github.com/chemprop/chemprop.git
...
- Why SuperAGI uses it: Chemistry property prediction adapter
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/chemprop/chemprop.git for upstream authorship and terms.
