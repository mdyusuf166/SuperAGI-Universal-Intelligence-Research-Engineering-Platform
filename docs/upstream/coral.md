...
- Project name: coral
- GitHub URL: https://github.com/Human-Agent-Society/CORAL.git
- Purpose: Agent evaluation and evolution research
...
- Why SuperAGI uses it: Continuous evaluation and controlled self-improvement
...
- Attribution: Copyright and license notices remain in the upstream checkout. See https://github.com/Human-Agent-Society/CORAL.git for upstream authorship and terms.
